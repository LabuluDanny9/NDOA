  ...
  return (
    ...
    >
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        {images.map((src) => (
          <motion.div key={src} className="overflow-hidden rounded-[1.75rem] bg-slate-950/80 shadow-inner shadow-black/30">
            <img src={src} alt="Photos mariage" className="h-64 w-full object-cover" />
          </motion.div>
        ))}
      </div>
    </motion.section>
